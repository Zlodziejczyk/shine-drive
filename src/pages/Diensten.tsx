...
export default function Diensten() {
  ...
  usePageMeta({
    title: t('pages.diensten.metaTitle'),
    description: t('pages.diensten.metaDescription'),
  });
    ...
    <>
      <section className="relative flex min-h-[50vh] items-center justify-center bg-surface pt-20">
        ...
        <Container className="relative text-center">
          ...
          >
            {t('pages.diensten.heading')} <span className="text-primary">{t('pages.diensten.headingHighlight')}</span>
          </motion.h1>
          <motion.p
